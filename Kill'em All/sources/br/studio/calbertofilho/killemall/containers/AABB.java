...
import br.studio.calbertofilho.killemall.entities.Entity;
...
public class AABB { //Axis Aligned Bounding Boxes
	...
	public AABB(VectorPosition position, int radius, Entity actor) {
		this();
	...
	private void setCircle(VectorPosition position, int radius, Entity actor) {
		this.position = position;
		this.radius = radius;
		this.actor = actor;
		this.size = radius;
